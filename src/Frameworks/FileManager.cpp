...
std::string FileManager::GetTextureFileNameFromPath(const std::string& filePath) {
    std::regex fileNameRegex(".*Textures\\/(\\w+)\\.*.");
    std::smatch match;
...
FileManager::VertexAttributeFile FileManager::CreateVertexAttributeFile(const std::string& sceneElementName) {
    ...
    vertexAttributeFile.Vertices.insert(vertexAttributeFile.Vertices.end(),
...
std::string FileManager::ConvertVertexAttributeFileToString(FileManager::VertexAttributeFile vertexAttributeFile) {
    ...
    std::for_each(vertexAttributeFile.texturePaths.begin(), vertexAttributeFile.texturePaths.end(),
